...
/**
 * This class implements the common parts of directed and undirected graphs
 * using an adjacency list representation. Only adding edges is different
 * between the two.
 * 
 * @author Ian Hayes
 *
 ...
 * @param <E>
 *            type of information stored with each edge
 */
abstract class GraphAdj<V extends Vertex, E> implements Graph<V, E> {

	/**
	 * A graph is represented by a list of Ventry elements, each of which
	 * contains a vertex and a list of adjacent edges.
	 */
	...
	/**
	 * Adding an edge is different for directed and undirected graphs and hence
	 * the method is abstract in this class.
	 * 
	 * @param u
	 *            source vertex
	 * @param v
	...
	/**
	 * The iterator over vertices uses the list iterator over the entries in the
	 * graph and selects the vertex from the entry.
	 */
